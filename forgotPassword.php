        ...
        <div class="container">
            ...
            if (!isset($_POST["username"])) {
                ...
                if (isset($_pwd[$_POST["username"]])) {
                    ...
                    echo "<div class=\"container\"><h3>Di seguito vengono riportate le tue pwd di accesso:</h3>";
                    ...
                    echo "<input type=\"text\" name=\"showPsw\" value=\"" . $_pwd[$_POST["username"]] . "\" readonly></div>";
                } else {
                    ...
                    echo "<span class=\"psw\">Torna al <a href=\"forgotPassword.php\">recupero pwd</a></span></div><br><div>";
                }
            }
            ?>
        </div>
